    ...
    pub fn get_cometix() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_default::burn_rate_segment(),
                theme_default::projected_exhaust_segment(),
    ...
    pub fn get_minimal() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_minimal::weekly_usage_segment(),
                theme_default::burn_rate_segment(),
                theme_default::projected_exhaust_segment(),
    ...
    pub fn get_gruvbox() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_gruvbox::weekly_usage_segment(),
                theme_default::burn_rate_segment(),
                theme_default::projected_exhaust_segment(),
    ...
    pub fn get_nord() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_nord::weekly_usage_segment(),
                theme_default::burn_rate_segment(),
                theme_default::projected_exhaust_segment(),
    ...
    pub fn get_powerline_dark() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_dark::weekly_usage_segment(),
                theme_default::burn_rate_segment(),
                theme_default::projected_exhaust_segment(),
    ...
    pub fn get_powerline_light() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_light::weekly_usage_segment(),
                theme_default::burn_rate_segment(),
                theme_default::projected_exhaust_segment(),
    ...
    pub fn get_powerline_rose_pine() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_rose_pine::weekly_usage_segment(),
                theme_default::burn_rate_segment(),
                theme_default::projected_exhaust_segment(),
    ...
    pub fn get_powerline_tokyo_night() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_tokyo_night::weekly_usage_segment(),
                theme_default::burn_rate_segment(),
                theme_default::projected_exhaust_segment(),
